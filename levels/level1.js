...
function level1() {
  return new Level(
    ...
    [
      ...
      new Collectibles("coin", 4400, 270, 120, 120),
      new Collectibles("coin", 4400, 320, 120, 120),
